...
| Doc | Role |
|---|---|
| **[PRD.md](./PRD.md)** | **Active** — full surface & materials PRD |
| **[SOW.md](./SOW.md)** | **Active** — Phase 1 Scope of Work (also PRD §6) |
| **[V1-LAUNCH.md](./V1-LAUNCH.md)** | **Active** — Lean V1 scope lock (3–5 public SKUs) |
| **[DISCOVERY.md](./DISCOVERY.md)** | Phase 01 research & Gate 01 |
| **[COLD-INSTALL.md](./COLD-INSTALL.md)** | Operator checklist — free material into fresh Next+Tailwind under 60s (also `/docs/cold-install`) |
