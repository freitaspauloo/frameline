...
export const RETICLE_LOGIN_ART =
  "https://aruyghvpjdiiuiesaupw.supabase.co/storage/v1/object/public/miracle-assets/miracle_cover.png";

export const RETICLE_MAGENTA = "#D600BF";

/**
 * Reticle sign-in — split panel, magenta-tinted art, GSAP entrance.
 * Preview: `/dev/miracle-login` · skeleton: `/dev/miracle-login/skeleton`
 */
