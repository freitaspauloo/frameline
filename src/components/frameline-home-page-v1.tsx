...
const FAQ_ITEMS = [
  {
    ...
    a: "Yes. Materials install as source in your repo â€” typed React components you can edit, theme, and ship.",
  },
  {
  ...
  },
  {
    ...
    a: "Materials are token-bound by default. Wire colors to your theme â€” they shouldnâ€™t force Framelineâ€™s palette.",
  },
] as const;
...
export function FramelineHomePageV1() {
  ...
  return (
    <MarketingShell>
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl">
          ...
          >
            <div className="max-w-3xl space-y-5">
              ...
              >
                Shippable surface â€” so you donâ€™t ship the default AI look.
              </p>
      ...
      <MarketingSection>
        <MarketingSectionHeader>
          <SectionIntro
            ...
            description="Editorial drops â€” materials grouped by job, not by trend."
            eyebrow="Collections"
          ...
          left={
            <div className="space-y-5">
              ...
              <p className="max-w-[42ch] text-base leading-relaxed text-muted-foreground">
                ...
                against your tokens â€” no locked runtime.
              </p>
        ...
        <MarketingSplit
          left={
            <div className="space-y-5">
              ...
              <p className="max-w-[42ch] text-base leading-relaxed text-muted-foreground">
                Open any material, adjust props, and copy JSX â€” the surface is
      ...
      {/* â€”â€” Why Frameline â€”â€” */}
      <MarketingSection>
        <MarketingSectionHeader>
          <SectionIntro
            description="Gradients, textures, and motion â€” typed React components, token-bound, production-safe."
