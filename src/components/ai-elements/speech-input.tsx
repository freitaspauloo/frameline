...
interface WebSpeechRecognition extends EventTarget {
  ...
  onresult:
    | ((this: WebSpeechRecognition, ev: SpeechRecognitionEvent) => void)
    | null;
  onerror:
...
/**
 * Resolved off `window` rather than declared globally: other packages in this
 * app already augment `Window` with their own SpeechRecognition shape.
 */
const getSpeechRecognitionConstructor = ():
  ...
  return candidate as (new () => WebSpeechRecognition) | undefined;
};
