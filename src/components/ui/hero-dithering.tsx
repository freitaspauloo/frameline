...
export function HeroDitheringContainer({
  ...
  return (
    <div
      className={cn(
        "relative z-10 mx-auto grid w-full max-w-7xl gap-6 pb-16 sm:gap-8 sm:pb-20 lg:grid-cols-[1fr_minmax(320px,560px)] lg:items-center lg:gap-12 lg:pb-24 xl:grid-cols-[1fr_1fr]",
        className
      )}
...
export function HeroDitheringCTA({
  ...
  return (
    ...
    >
      <Button
        className={cn("rounded-full px-6 font-pixel-square", buttonClassName)}
        nativeButton={false}
        render={
    ...
    >
      {resolvedTechStack.map((tech, index) => {
        ...
        const defaultBadge = (
          <Badge
            className={cn(
              "group relative h-auto min-h-8 px-3.5 py-2.5 font-medium transition-all duration-150",
...
export function HeroDitheringVisual({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto hidden aspect-square w-full max-w-[500px] lg:mx-0 lg:ml-auto lg:block xl:max-w-[560px]",
        className
      )}
